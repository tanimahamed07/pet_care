...
const ServiceCard = ({ service }) => {
  return (
    <div
      ...
      className="card shadow-xl  bg-gradient-to-l from-blue-50 to-white border border-blue-100  hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 backdrop-blur-md rounded-2xl"
    >
      <figure>
        <img
          src={service.image}
